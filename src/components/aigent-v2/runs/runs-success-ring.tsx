...
import { formatPercent, type RunsMetrics } from '@/lib/aigent-v2/runs-metrics'
...
export function RunsSuccessRing({ metrics }: { metrics: RunsMetrics }) {
  ...
  return (
    <Panel inset="md" className="flex flex-col" role="region" aria-labelledby="v2-success-heading">
      <Subheading id="v2-success-heading" level={2}>
        Success rate
      </Subheading>
