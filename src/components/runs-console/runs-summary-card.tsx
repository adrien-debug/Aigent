...
import { PERIOD_LABEL, type RunsPeriod } from '@/lib/runs-console/runs-filters'
import { formatUsd, type RunsMetrics } from '@/lib/runs-console/runs-metrics'
...
export function RunsSummaryCard({
  ...
  return (
    <section className="flex flex-col rounded-2xl bg-surface-raised p-6" aria-labelledby="runs-heading">
      <Heading id="runs-heading" level={1}>
        Runs
      </Heading>
