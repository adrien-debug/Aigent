...
import { RunsActivityPanel } from '@/components/runs-console/runs-activity-panel'
import { RunsCardList } from '@/components/runs-console/runs-card-list'
import { RunsEmptyState } from '@/components/runs-console/runs-empty-state'
import { RunsFilters, type FilterOption } from '@/components/runs-console/runs-filters'
import { RunsSummaryCard } from '@/components/runs-console/runs-summary-card'
import { RunsSuccessRing } from '@/components/runs-console/runs-success-ring'
import { RunsTable } from '@/components/runs-console/runs-table'
import { toRunRowModel } from '@/components/runs-console/run-row-model'
import { Subheading } from '@/components/ui/heading'
import { deriveAgentActivity } from '@/lib/runs-console/runs-activity'
import {
...
export function RunsView({
  ...
  return (
    // The page renders CONTENT only. The rail and the topbar belong to
    // `app/admin/layout.tsx`, and the search field lives there — this view
    // reads `q` from the URL through `initialFilters` instead of owning a
    // second input that could disagree with it.
    <>
      <div className="flex flex-col gap-4">
        ...
        <div className="grid gap-4 min-[1700px]:grid-cols-3">
          <section className="flex min-w-0 flex-col rounded-2xl bg-surface-raised p-6 min-[1700px]:col-span-2">
