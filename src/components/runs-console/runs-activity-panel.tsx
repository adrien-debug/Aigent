...
import type { AgentActivityRow } from '@/lib/runs-console/runs-activity'
import { formatUsd } from '@/lib/runs-console/runs-metrics'
...
export function RunsActivityPanel({
  ...
  return (
    <section className="flex flex-col rounded-2xl bg-surface-raised p-6" aria-labelledby="activity-heading">
      <Subheading id="activity-heading" level={2}>
        Most active agents
      </Subheading>
