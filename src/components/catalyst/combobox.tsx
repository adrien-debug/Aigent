    ...
    <Headless.Combobox {...props} multiple={false} virtual={{ options: filteredOptions }} onClose={() => setQuery('')}>
      <span
        ...
        className={clsx([
          ...
          // Invalid state
          'has-data-invalid:before:shadow-accent-500/10',
        ])}
      >
        <Headless.ComboboxInput
          ...
          className={clsx([
            ...
            // Invalid state
            'data-invalid:border-accent-500 data-invalid:data-hover:border-accent-500 dark:data-invalid:border-accent-500 dark:data-invalid:data-hover:border-accent-500',
            // Disabled state
