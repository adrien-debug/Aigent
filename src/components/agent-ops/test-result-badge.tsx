...
const resultConfig: Record<
  TestResultStatus,
  { label: string; color: 'accent' | 'accentStrong' | 'accentSolid' | 'zinc' }
> = {
  pass: { label: 'Pass', color: 'accent' },
  fail: { label: 'Fail', color: 'accentSolid' },
  error: { label: 'Error', color: 'accentStrong' },
