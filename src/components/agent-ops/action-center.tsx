...
function ActionRow({ item }: { item: ActionItem }) {
  ...
  return (
    <li className="group grid min-h-14 grid-cols-[1.25rem_minmax(0,1fr)_auto] items-center gap-3 px-4 py-3 transition-colors duration-150 hover:bg-(--color-surface-focus)">
      <Icon
        aria-hidden="true"
