    ...
    >
      <Headless.Input
        ...
        className={cn([
          ...
          // Typography
          'text-base/6 text-zinc-950 placeholder:text-zinc-500 sm:text-sm/6 dark:text-content dark:placeholder:text-content-subtle',
          // Border
          'border border-zinc-950/10 data-hover:border-zinc-950/20 dark:border-line dark:data-hover:border-line-strong',
          // Background color
          'bg-transparent dark:bg-surface-sunken',
