  ...
  return (
    <div className="space-y-8">
      ...
      <p className="flex items-center gap-2 px-1 text-xs text-zinc-500">
        ...
        <span>
          <span className="font-medium text-amber-600 dark:text-amber-400">Safety rule</span> — high &amp; critical risk tools always
          require human confirmation. This lock cannot be removed per tool.
        </span>
      </p>
    </div>
  )
