...
export default function NotFound() {
  return (
    <main className="flex flex-1 items-center justify-center p-6">
      <div className="w-full max-w-md rounded-xl bg-white p-6 text-center ring-1 ring-zinc-950/5 dark:bg-surface-app dark:ring-white/10">
        {/* `dark:text-content-muted`, not a bare `text-zinc-500`: measured by
        ...
        <p className="font-mono text-xs tabular-nums text-zinc-500 dark:text-content-muted">Error 404</p>
