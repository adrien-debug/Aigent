        ...
        <div className="h-full p-4">
          <div className="flex h-full items-center justify-center rounded-lg bg-white shadow-xs ring-1 ring-zinc-950/5 dark:bg-zinc-900 dark:ring-white/10">
            <div className="max-w-md px-6 text-center">
              <Unavailable
                reason="unread"
                detail="Le registre des copilots n’a pas pu être lu. Aucun banc de livraison n’est affiché — une liste vide se lirait comme « aucun agent », ce qui n’est pas ce qui est su."
              />
