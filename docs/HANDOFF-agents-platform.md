...
- **Aigent** : `/Users/adrienbeyondcrypto/Aigent`, branche `main`, HEAD `1f0bde4`,
  ...
  Dev : `npm run dev` (Next + LangGraph). Le dev Aigent tourne sur `:3987`
  (`AIGENT_DEV_PORT`, défaut 3987 — jamais `:3000`/`:3001`/`:3210`, cf. AGENTS.md ;
  LangGraph `:2024`). Login dev : mdp `hearst-agent-mc-2026`.
